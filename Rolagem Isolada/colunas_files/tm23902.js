var nvg23902 = new function(){
    ...
    this.tagCode = 'var NVG_qry="",nvg_tmp_a,nvg_tmp_b,nvg_parms=["gender","age","education","interest","product","income","marital","brand","career","cluster","connection","prolook","city","region","country","custom"];function navegg_callback(){for(nvg_i=0;nvg_parms[nvg_i];nvg_i++){nvg_tmp_a=nvgGetSegment(nvg_parms[nvg_i]).split("-");for(nvg_tmp_b=0;nvg_tmp_a[nvg_tmp_b];nvg_tmp_b++)try{NVG_qry+="&"+nvg_parms[nvg_i]+"=";NVG_qry+=nvg_tmp_a[nvg_tmp_b].replace(/&/g,"")}catch(e){NVG_qry+="&"+nvg_parms[nvg_i]+"=";NVG_qry+=nvg_tmp_a[nvg_tmp_b].replace(/&/g,"")}}}nvg23902.setCustomTargeting(Array(Array("politica.estadao.com.br")),882);nvg23902.setCustomTargeting(Array(Array("economia.estadao.com.br")),883);nvg23902.setCustomTargeting(Array(Array("pme.estadao.com.br")),891);nvg23902.setCustomTargeting(Array(Array("estadao.com.br/paladar/")),892);nvg23902.setCustomTargeting(Array(Array("estadao.com.br/jornal-do-carro/")),893);nvg23902.setCustomTargeting(Array(Array("assineestadao.com.br")),894);nvg23902.setCustomTargeting(Array(Array("assineestadao.com.br"),Array("pedidofechado")),895);';
    this.tag = 'city:product:productlookalike:career:gender:age:custom:brand:marital:country:cluster:connection:interest:income:education:region';
...
{
    return nvg23902.getSegment(f);
};

function ltgc(s)
{
    return nvg23902.getSegment(s);
};
